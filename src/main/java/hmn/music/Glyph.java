...
public class Glyph {
  ...
  public static Glyph DOUBLE_FLAT = new Glyph((char)61514, 16, -1, 4);
  public static Glyph DOUBLE_SHARP = new Glyph((char)61515, 16, 0, 7);
  ...
  public Glyph(char code, double scale, double dx, double dy){
    this.code = code;
